async function updatePassword() {
    ...
    if (response.ok) {
        ...
        if (json.status) {
            ...
            if (json.message === "1") {
                document.getElementById("notification").innerHTML = "Session was timeout.";
                document.getElementById("loginNotification").classList.remove('d-none');
                ...
                document.getElementById("notification").innerHTML = "Your email address can not be found in our database. Please sign up again!";
                document.getElementById("loginNotification").classList.remove('d-none');
