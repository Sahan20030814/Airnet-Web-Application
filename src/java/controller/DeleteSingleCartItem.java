 ...
 * @author sahan
 */
@WebServlet(name = "DeleteSingleCartItem", urlPatterns = {"/DeleteSingleCartItem"})
public class DeleteSingleCartItem extends HttpServlet {
                    ...
                    if (request.getSession() != null && request.getSession().getAttribute("user") != null) {
                        ...
                        if (sessionCarts != null) {
                            for (Cart sessionCart : sessionCarts) {
                                if (sessionCart.getMainMovie().getId() == deletingContent.getId()) {
