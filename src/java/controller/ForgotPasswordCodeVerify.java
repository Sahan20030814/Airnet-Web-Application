 ...
 * @author sahan
 */
@WebServlet(name = "ForgotPasswordCodeVerify", urlPatterns = {"/ForgotPasswordCodeVerify"})
public class ForgotPasswordCodeVerify extends HttpServlet {
        ...
        if (ses.getAttribute("email") == null) {
            ...
            if (c1.list().isEmpty()) {
                ...
                if (!verification_code.equals(u1.getVerification())) {
                    ...
                    request.getSession().setAttribute("forgotPasswordVerify", "verified");
