 ...
 * @author sahan
 */
@WebServlet(name = "AdminForgotPasswordCodeVerify", urlPatterns = {"/AdminForgotPasswordCodeVerify"})
public class AdminForgotPasswordCodeVerify extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        request.getSession().setAttribute("forgotPasswordAdminVerify", "notVerified");
        ...
        if (ses.getAttribute("adminEmail") == null) {
            ...
            if (c1.list().isEmpty()) {
                ...
                if (!verification_code.equals(a.getVerification())) {
                    ...
                    request.getSession().setAttribute("forgotPasswordAdminVerify", "verified");
