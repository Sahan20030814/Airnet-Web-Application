 ...
 * @author sahan
 */
@WebServlet(name = "ResendForgotPasswordVerification", urlPatterns = {"/ResendForgotPasswordVerification"})
public class ResendForgotPasswordVerification extends HttpServlet {
